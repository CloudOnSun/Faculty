...
void testAll() { //apelam fiecare functie sa vedem daca exista
	...
	Multime mult1, mult2, mult3;
	assert(mult2.submultime(mult1)); // mult vida este submult la mult vida
	mult1.adauga(1);
	mult1.adauga(2);
	mult1.adauga(3);
	mult1.adauga(4);
	mult1.adauga(5);
	assert(mult2.submultime(mult1)); // mult vida este submult pentru orice multime
	mult2.adauga(2);
	mult2.adauga(4);
	mult2.adauga(5);
	assert(mult2.submultime(mult1)); // mult2 este submult petnru mult1
	mult3.adauga(2);
	mult3.adauga(8);
	assert(!mult3.submultime(mult1)); // mult3 nu este submult petnru mult1
}
