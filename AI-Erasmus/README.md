# Description
This directory cotains all the assigments done during my Erasmus+ mobility in Prague, at Charles University, taking the course AI 1 NAIL069 by professor Roman Barták PhD.
All the games were implemented by the faculty and all the credits go to them. For every game, my contributions were the Agent class and the AI search algorithm.
The following parts are from the initial README
